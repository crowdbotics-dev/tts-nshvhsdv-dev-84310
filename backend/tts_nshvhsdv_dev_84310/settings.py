"""
Django settings for tts_nshvhsdv_dev_84310 project.
...
ROOT_URLCONF = 'tts_nshvhsdv_dev_84310.urls'
...
WSGI_APPLICATION = 'tts_nshvhsdv_dev_84310.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tts_nshvhsdv_dev_84310 API",
    "DESCRIPTION": "API documentation for tts_nshvhsdv_dev_84310 App",
    "VERSION": "v1",
}
